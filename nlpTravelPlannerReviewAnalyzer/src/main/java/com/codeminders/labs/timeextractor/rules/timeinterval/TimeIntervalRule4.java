...
public class TimeIntervalRule4 extends BaseRule {
	...
	public TimeIntervalRule4(String tag, String hours, String minutes,
			String pMAm, String timezone) {
		this.tag = tag;
		this.hours = hours;
	...
	public TimeIntervalRule4(String tag, String hours, String pMAm,
			String timezone) {
		this.tag = tag;
		this.hours = hours;
		this.pMAm = pMAm;
