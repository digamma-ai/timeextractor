...
public class TemporalExtractionService {
    ...
    public List<AnnotationInterval> getAllAnotations(List<TemporalExtraction> annotations) {
        ...
        for (TemporalExtraction cm : annotations) {
            ...
            if (cm.getTemporal() != null && cm.getTemporal().get(0).getType() != null) {
                Type type = converter.getGeneralType(cm.getTemporal().get(0).getType());
    ...
    public Map<String, List<TemporalExtraction>> extractDatesAndTimeFromMultipleText(List<BaseText> baseTexts) {
    ...
    private Map<String, List<AnnotationIntervalHtml>> getAnnotationIntervalsForHtml(Map<HtmlElement, List<TemporalExtraction>> map) {
        ...
        for (Map.Entry<HtmlElement, List<TemporalExtraction>> entry : map.entrySet()) {
            ...
            for (TemporalExtraction annotation : annotations) {
                ...
                String extractedText = textCleaner.cleanText(element.getExtractedText());
