...
public class TemporalConstants {
    ...
    public static final String HOLIDAYS = "((halloween)|(christmas)|(new year)|(independence day)|(thanksgiving)|((st[.]?|saint)[\\s]*(valentine|valentine's|valentines)[\\s]*(day)?))";
    ...
    public static final String TIME_ZONE = "(PST|EST|(EEST|(Eastern Europe Summer Time))|ET|EDT|CST|(CET|Central European Time)|(CEST|Central European Summer Time)|BST|PDT|GMT|UTC|IST|MSD|MSK|WEST|WET|JST|IDT|HKT)";
    public static final String TIME_OF_DAY = "(morning|afternoon|evening|night|midday|noon|midnight)";
    public static final String DURATION = "(seconds|sec|minutes|minute|mins|min|mns|mn|hours|hour|hrs|weeks|week|months|month|years|year|days|day)";
    public static final String BASIC_NUMBER_ONE_TEN = "(one|two|three|four|five|six|seven|eight|nine|ten)";
