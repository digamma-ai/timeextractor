...
public class FilterRules1 extends Rule {
    ...
    private String rule = "\\b((the sun)|(may be)|(may do)|(may try)|(may have)|(may influence)|(may never have)|(may not be)|(spring fall)|(wall fall)|(water fall)|(the fall of)|(fall[s]? again)|(\\d[.]\\d[%]))|(by[\\s]*[1-9][1-9]?[.][1-9][\\s]*([%]|(percent)))\\b";
