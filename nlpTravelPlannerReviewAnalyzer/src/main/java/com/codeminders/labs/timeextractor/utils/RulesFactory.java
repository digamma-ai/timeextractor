...
import com.codeminders.labs.timeextractor.rules.composite.CompositeDateIntervals;
...
import com.codeminders.labs.timeextractor.rules.set.CompositeSet2;
...
public class RulesFactory {
    ...
    public BaseRule getBaseRule(Object obj, String name) {
        ...
        case ("CompositeDayOfWeekDate"):
            return (CompositeDayOfWeekDate) obj;
        case ("Dateinterval2"):
            return (Dateinterval2) obj;
        case ("TimeIntervalRule5"):
            return (TimeIntervalRule5) obj;
        case ("CompositeDateIntervals"):
            return (CompositeDateIntervals) obj;
        case ("CompositeSet2"):
            return (CompositeSet2) obj;
        case ("DateInterval3"):
