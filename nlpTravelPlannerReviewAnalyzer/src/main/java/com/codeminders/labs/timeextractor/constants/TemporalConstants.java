...
public class TemporalConstants {
    ...
    public static final String HOLIDAYS = "((halloween)|(christmas eve)|(christmas day)|(christmas)|(new year's day)|(new year day)|(new year)|(independence day)|(thanksgiving)|(Veterans Day)|(Columbus Day)|(Labor Day)|(Memorial Day)|(Washington's Birthday)|(Martin Luther King, Jr. Day)|(Martin Luther King Day)|(Inauguration Day)|((st[.]?|saint)[\\s]*(valentine|valentine's|valentines)[\\s]*(day)?))";
    ...
    public static final String TIME_ZONE = "(PST|BST|PT|EST|(EEST|(Eastern Europe Summer Time))|ET|(EDT|Eastern Daylight Time)|CST|(CET|Central European Time)|(CEST|Central European Summer Time)|BST|PDT|GMT|UTC|IST|MSD|MSK|WEST|WET|JST|IDT|HKT)";
    public static final String TIME_OF_DAY = "(morning|afternoon|evening|night|midday|noon|midnight)";
    public static final String DURATION = "(seconds|sec|minutes|minute|mins|min|mns|mn|hours|hour|hrs|hr|weeks|week|months|month|years|year|days|day)";
