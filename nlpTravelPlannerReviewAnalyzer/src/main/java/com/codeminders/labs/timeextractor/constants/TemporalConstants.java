...
public class TemporalConstants {
    ...
    public static final String HOLIDAYS = "((halloween)|(christmas eve)|(christmas day)|(christmas)|(new year's day)|(new year day)|(New Year s' Eve)|(New Year's Eve)|(new year)|(independence day)|(thanksgiving)|(Veterans Day)|(Columbus Day)|(Labor Day)|(Memorial Day)|(Washington's Birthday)|(Martin Luther King, Jr. Day)|(Martin Luther King Day)|(Inauguration Day)|((st[.]?|saint)[\\s]*(valentine|valentine's|valentines)[\\s]*(day)?))";
