...
public class TemporalParser {
	...
	public Temporal getRelativeTemporalObjectByProperty(String property,
			LocalDate localDate) {

		if (property.equalsIgnoreCase("today")) {
			TimeDate timeDate = getTimeDate(localDate);
			return TemporalObjectGenerator.generateTemporalTime(Type.DATE,
					timeDate);
	...
	public Temporal getDuration(String durationType, int durationLength) {
		...
		if (durationType.equalsIgnoreCase("minutes")
				|| durationType.equalsIgnoreCase("minute")
				|| durationType.equalsIgnoreCase("mins")
				|| durationType.equalsIgnoreCase("min")
				|| durationType.equalsIgnoreCase("mns")
				|| durationType.equalsIgnoreCase("mn")) {
			duration = new Duration();
			duration.setMinutes(durationLength);
		}

		if (durationType.equalsIgnoreCase("hours")
				|| durationType.equalsIgnoreCase("hour")
				|| durationType.equalsIgnoreCase("hrs")) {
			duration = new Duration();
			duration.setHours(durationLength);
		}

		if (durationType.equalsIgnoreCase("weeks")
				|| durationType.equalsIgnoreCase("week")) {
			duration = new Duration();
			duration.setWeeks(durationLength);
		}

		if (durationType.equalsIgnoreCase("months")
				|| durationType.equalsIgnoreCase("month")) {
			duration = new Duration();
			duration.setMonths(durationLength);
		}

		if (durationType.equalsIgnoreCase("years")
				|| durationType.equalsIgnoreCase("year")) {
			duration = new Duration();
			duration.setYears(durationLength);
		}

		if (durationType.equalsIgnoreCase("days")
				|| durationType.equalsIgnoreCase("day")) {
			duration = new Duration();
			duration.setDays(durationLength);
		}

		return TemporalObjectGenerator.generateTemporalDuration(Type.DURATION,
				duration);
	...
	public Temporal getTimeOfDay(String timeOfDay) {
		...
		if (timeOfDay.equalsIgnoreCase("morning")
				|| timeOfDay.equalsIgnoreCase("mornings")) {
		...
		if (timeOfDay.equalsIgnoreCase("afternoon")
				|| timeOfDay.equalsIgnoreCase("afternoons")) {
		...
		if (timeOfDay.equalsIgnoreCase("evening")
				|| timeOfDay.equalsIgnoreCase("evenings")) {
		...
		if (timeOfDay.equalsIgnoreCase("night")
				|| timeOfDay.equalsIgnoreCase("nights")) {
		...
		if (timeOfDay.equalsIgnoreCase("midnight")
				|| timeOfDay.equalsIgnoreCase("midnights")) {
		...
		if (timeOfDay.equalsIgnoreCase("noon")
				|| timeOfDay.equalsIgnoreCase("noons")) {
			Time startTime = new Time(12, 0, 0);
			Time endTime = new Time(12, 0, 0);
			start.setTime(startTime);
			end.setTime(endTime);
		...
		if (timeOfDay.equalsIgnoreCase("midday")
				|| timeOfDay.equalsIgnoreCase("middays")) {
			Time startTime = new Time(12, 0, 0);
			Time endTime = new Time(12, 0, 0);
			start.setTime(startTime);
			end.setTime(endTime);
	...
	public Temporal getTemporalForEveryPeriod(String period) {
		...
		if (period.equalsIgnoreCase("day") || period.equalsIgnoreCase("daily")) {
			...
			return temporal;
				...
				|| period.equalsIgnoreCase("annual")) {
